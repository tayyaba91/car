<?php  Namespace CarDealerPlugin_last_feedback{
    if (!defined('ABSPATH'))
        ...
        elseif ( __NAMESPACE__ == 'CarDealerPlugin_last_feedback')
        {
               ...
               <div class="<?php echo PRODCLASS;?>-wrap-deactivate" style="display:none">
                  <div class="bill-vote-gravatar"><a href="http://profiles.wordpress.org/sminozzi" target="_blank"><img src="https://en.gravatar.com/userimage/94727241/31b8438335a13018a1f52661de469b60.jpg?size=100" alt="Bill Minozzi" width="70" height="70"></a></div>
                    <div class="bill-vote-message">
                     ...
                     <br /><br /> 
                     <textarea rows="4" cols="50" id="<?php echo PRODCLASS;?>-explanation" name="explanation" placeholder="<?php _e("type here yours sugestions and/or issues...",LANGUAGE);?>" ></textarea>
                     <br /><br /> 
                     ...
                     <br /><br /> 	
                            ...
                            <a href="https://BillMinozzi.com/dove/" class="button button-primary <?php echo PRODCLASS;?>-close-dialog"><?php _e("Support Page",LANGUAGE);?></a>

                            <a href="#" class="button button-primary <?php echo PRODCLASS;?>-close-submit"><?php _e("Submit and Deactivate",LANGUAGE);?></a>
                            <img src="/wp-admin/images/wpspin_light-2x.gif" id="imagewaitfbl" style="display:none" />
                            <a href="#" class="button <?php echo PRODCLASS;?>-close-dialog"><?php _e("Cancel",LANGUAGE);?></a>
                            <a href="#" class="button <?php echo PRODCLASS;?>-deactivate"><?php _e("Just Deactivate",LANGUAGE);?></a>
